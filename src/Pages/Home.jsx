...
const Home = () => {
  ...
  const clientCount = useCountUp(150, 3000);
  const retentionRate = useCountUp(95, 3000);
  const adReach = useCountUp(10, 3000);
    ...
    <div className="bg-white">
      <section className="py-20 px-10 text-center bg-linear-to-r from-blue-50 to-indigo-50">
        ...
        >
          ...
          {/* Quick Stats */}
          <div className="flex justify-around py-12 border-b border-gray-100 bg-white mt-10">
